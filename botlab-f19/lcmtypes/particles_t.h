 ...
 */
typedef void(*particles_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const particles_t *msg, void *userdata);
 ...
 */
particles_t_subscription_t* particles_t_subscribe(lcm_t *lcm, const char *channel, particles_t_handler_t handler, void *userdata);
