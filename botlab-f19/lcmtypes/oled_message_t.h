 ...
 */
typedef void(*oled_message_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const oled_message_t *msg, void *userdata);
 ...
 */
oled_message_t_subscription_t* oled_message_t_subscribe(lcm_t *lcm, const char *channel, oled_message_t_handler_t handler, void *userdata);
...
int64_t __oled_message_t_hash_recursive(const __lcm_hash_ptr *p);
