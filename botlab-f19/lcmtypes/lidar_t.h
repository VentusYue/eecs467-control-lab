 ...
 * lidar_t is received.
 */
typedef void(*lidar_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lidar_t *msg, void *userdata);
 ...
 */
lidar_t_subscription_t* lidar_t_subscribe(lcm_t *lcm, const char *channel, lidar_t_handler_t handler, void *userdata);
...
int64_t __lidar_t_hash_recursive(const __lcm_hash_ptr *p);
