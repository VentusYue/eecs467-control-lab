 ...
 */
typedef void(*particle_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const particle_t *msg, void *userdata);
 ...
 */
particle_t_subscription_t* particle_t_subscribe(lcm_t *lcm, const char *channel, particle_t_handler_t handler, void *userdata);
