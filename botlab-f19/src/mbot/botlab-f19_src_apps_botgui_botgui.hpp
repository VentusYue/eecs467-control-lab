...
public:
    ...
    */
    ...
    void handleTurn(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const turn_t* turn);
    void handleLidar(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const odometry_t* odom);
...
private:
    ...
    // EECS 467 Added
    std::vector<std::array<float, 3>>squares;
